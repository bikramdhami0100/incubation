            ...
            <div className="flex-shrink-0">
              {item.imageUrl ? (
                <Image
                  ...
                  width={80}
                  height={80}
                  className=" h-[40px]  w-[40px] rounded-[20px] object-cover border-4 border-white/50 shadow-lg"
                />
              ) : (
                <div
                  className={`w-16 h-16 bg-white bg-opacity-20 rounded-full flex items-center justify-center bg-gradient-to-br ${getGradientColors(
                    item.category
                  )}`}
                >
